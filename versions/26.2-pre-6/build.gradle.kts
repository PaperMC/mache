...
dependencies {
    ...
    constants("io.papermc.unpick-definitions:unpick-definitions:26.2-snapshot-6+build.4") // todo bump once https://github.com/FabricMC/unpick/issues/46 is fixed
}
